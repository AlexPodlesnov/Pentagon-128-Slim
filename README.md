...
* Конвертер +5В в +12В на микросхеме MC34063 разведен на оборотной стороне платы.
* Добавлена возможность установки готового конвертера +5В в +12В для питания контроллера дисковода ВГ93 (DC-DC STEP-UP FIX 5V TO 12V CKCS-BS01).
